...
namespace DOL.GS
{
    ...
    public enum eProperty : ushort
    {
        ...
        Skill_Helguard = 280,
        Skill_Draugr_Binding = 281,
        Skill_Niflheim_Runes = 282,
        Skill_Gravecaller = 283,
        Skill_Morrigans_Scythe = 284,
        Skill_Sidhe_Shade = 285,
        Skill_Umbral_Blade = 286,
        Skill_Cursed_Oath = 287,
        Skill_Grim_Aegis = 288,
        Skill_Blood_Arena = 289,
        Skill_Warborn_Guard = 290,
        Skill_Valkyries_Shout = 291,
        Skill_Wyrm_Lance = 292,
        Skill_Drakebond = 293,
        Skill_Sky_Sentinel = 294,
    ...
    public static class GlobalConstants
    {
        ...
        public static readonly Dictionary<eRealm, List<eCharacterClass>> STARTING_CLASSES_DICT = new Dictionary<eRealm, List<eCharacterClass>>()
        {
            ...
            {eRealm.Albion, new List<eCharacterClass>() {eCharacterClass.Fighter, eCharacterClass.Acolyte, eCharacterClass.Mage, eCharacterClass.Elementalist, eCharacterClass.AlbionRogue, eCharacterClass.Disciple,
                ...
                eCharacterClass.DarkKnight,		// DarkKnight = 74,
                eCharacterClass.RedMage,		// RedMage = 73,
                eCharacterClass.ChaosMage,		// ChaosMage = 76,
                eCharacterClass.Psion,		// Psion = 77,
            }},
            {eRealm.Midgard, new List<eCharacterClass>() {eCharacterClass.Viking, eCharacterClass.Mystic, eCharacterClass.Seer, eCharacterClass.MidgardRogue,
                ...
                eCharacterClass.HelWarden,	    // HelWarden = 68,
                eCharacterClass.Einherjar,		// Einherjar = 69,
                eCharacterClass.Geomancer,		// Geomancer = 70,
                eCharacterClass.Corsair,		// Corsair = 71,
                eCharacterClass.Alchemist,		// Alchemist = 72,
            }},
            {eRealm.Hibernia, new List<eCharacterClass>() {eCharacterClass.Guardian, eCharacterClass.Stalker, eCharacterClass.Naturalist, eCharacterClass.Magician, eCharacterClass.Forester,
                ...
                eCharacterClass.Reaper,	        // Reaper = 63,
                eCharacterClass.Dragoon,		// Dragoon = 64,
                eCharacterClass.BlueMage,		// BlueMage = 65,
                eCharacterClass.ElementalKnight,		// ElementalKnight = 66,
                eCharacterClass.PuppetMaster,		// PuppetMaster = 67,
            }},
        };
