...
namespace DOL.GS.PropertyCalc
{
    ...
    public class CriticalHealHitChanceCalculator : PropertyCalculator
    {
        ...
        public override int CalcValue(GameLiving living, eProperty property)
        {
            int percent = living.BaseBuffBonusCategory[(int)property] + living.OtherBuffBonus[(int)property] + living.AbilityBonus[(int)property];
    ...
    public class SpellDurationPercentCalculator : PropertyCalculator
    {
        ...
        {
            //hardcap at 25%
            return Math.Min(25, living.OtherBuffBonus[(int)property] + living.ItemBonus[(int)property]
                - living.DebuffCategory[(int)property]);
        }
    }
