        ...
        {
            {
                ...
                new DBCharacterClass()
                {
                    ...
                    MaxTensionFactor = 1.16f,
                    AdrenalineSpellID = AdrenalineSpellHandler.TANK_ADRENALINE_SPELL_ID,
                    MaxPulsingSpells = 2
                }
            },
            {
            ...
            },
            {
                ...
                new DBCharacterClass()
                {
                    ...
                    BaseWeaponSkill = 360,
                    ClassType = (byte)eClassType.Hybrid,
                    MaxTensionFactor = 1.07f,
                    AdrenalineSpellID = StealthAdrenalineSpellHandler.RANGED_ADRENALINE_SPELL_ID
                }
            },
            {
                ...
                new DBCharacterClass()
                {
                    ...
                    EligibleRaces = $"{(int)(PlayerRace.Briton.ID)},{(int)(PlayerRace.Highlander.ID)},{(int)(PlayerRace.Saracen.ID)},{(int)(PlayerRace.Inconnu.ID)}",
                    BaseHP = 720,
                    BaseWeaponSkill = 380,
                    ClassType = (byte)eClassType.Hybrid,
                    MaxPulsingSpells = 2,
                    MaxTensionFactor = 1.04f,
                    AdrenalineSpellID = StealthAdrenalineSpellHandler.RANGED_ADRENALINE_SPELL_ID
                }
            },
            {
                ...
                new DBCharacterClass()
                {
                    ...
                    MaxTensionFactor = 1.02f,
                    AdrenalineSpellID = AdrenalineSpellHandler.MAGE_ADRENALINE_SPELL_ID
                }
            },
            {
            ...
            },
            {
                ...
                new DBCharacterClass()
                {
                    ...
                    TertiaryStat = (int)eStat.QUI,
                    ManaStat = (int)eStat.INT,
                    EligibleRaces = $"{(int)(PlayerRace.Avalonian.ID)},{(int)(PlayerRace.Briton.ID)},{(int)(PlayerRace.HalfOgre.ID)},{(int)(PlayerRace.Inconnu.ID)}",
                    BaseHP = 560,
                    BaseWeaponSkill = 240,
                    ClassType = (byte)eClassType.ListCaster,
                    MaxTensionFactor = 1.02f,
            ...
            },
            {
                ...
                new DBCharacterClass()
                {
                    ...
                    TertiaryStat = (int)eStat.QUI,
                    ManaStat = (int)eStat.INT,
                    EligibleRaces = $"{(int)(PlayerRace.Avalonian.ID)},{(int)(PlayerRace.Briton.ID)},{(int)(PlayerRace.Inconnu.ID)},{(int)(PlayerRace.Saracen.ID)}",
                    BaseHP = 560,
                    BaseWeaponSkill = 280,
                    ClassType = (byte)eClassType.ListCaster,
                    MaxTensionFactor = 1.06f,
                    AdrenalineSpellID = AdrenalineSpellHandler.MAGE_ADRENALINE_SPELL_ID
                }
            },
            {
            ...
            {
                (byte)eCharacterClass.Occultist,
                new DBCharacterClass()
                {
                    ID = (byte)eCharacterClass.Occultist,
                    Name = "Occultist",
                    BaseClassID = (byte)eCharacterClass.Disciple,
                    ProfessionTranslationID = "PlayerClass.Profession.TempleofShadows",
                    SpecPointMultiplier = 10,
                    PrimaryStat = (int)eStat.INT,
                    SecondaryStat = (int)eStat.DEX,
                    TertiaryStat = (int)eStat.QUI,
            ...
            },
            {
                ...
                new DBCharacterClass()
                {
                    ...
                    ManaStat = (int)eStat.PIE,
                    EligibleRaces = $"{(int)(PlayerRace.Briton.ID)},{(int)(PlayerRace.Inconnu.ID)},{(int)(PlayerRace.Saracen.ID)},{(int)(PlayerRace.Korazh.ID)}",
                    BaseHP = 760,
                    BaseWeaponSkill = 380,
                    ClassType = (byte)eClassType.Hybrid,
                    MaxTensionFactor = 1.10f,
                    AdrenalineSpellID = AdrenalineSpellHandler.TANK_ADRENALINE_SPELL_ID
                }
            },
            {
            ...
            },
            {
                ...
                new DBCharacterClass()
                {
                    ...
                    TertiaryStat = (int)eStat.CON,
                    ManaStat = (int)eStat.PIE,
                    EligibleRaces = $"{(int)(PlayerRace.Dwarf.ID)},{(int)(PlayerRace.Frostalf.ID)},{(int)(PlayerRace.Deifrang.ID)},{(int)(PlayerRace.Norseman.ID)},{(int)(PlayerRace.Troll.ID)},{(int)(PlayerRace.Valkyn.ID)}",
                    BaseHP = 720,
                    BaseWeaponSkill = 360,
                    ClassType = (byte)eClassType.Hybrid,
                    MaxTensionFactor = 1.15f,
                    AdrenalineSpellID = AdrenalineSpellHandler.TANK_ADRENALINE_SPELL_ID
                }
            },
            {
            ...
            },
            {
                ...
                new DBCharacterClass()
                {
                    ...
                    TertiaryStat = (int)eStat.CON,
                    ManaStat = (int)eStat.CHR,
                    EligibleRaces = $"{(int)(PlayerRace.Dwarf.ID)},{(int)(PlayerRace.Kobold.ID)},{(int)(PlayerRace.Norseman.ID)},{(int)(PlayerRace.Troll.ID)},{(int)(PlayerRace.Deifrang.ID)}",
                    BaseHP = 760,
                    BaseWeaponSkill = 380,
                    ClassType = (byte)eClassType.Hybrid,
                    MaxPulsingSpells = 2,
            ...
            },
            {
                ...
                new DBCharacterClass()
                {
                    ...
                    TertiaryStat = (int)eStat.QUI,
                    ManaStat = (int)eStat.PIE,
                    EligibleRaces = $"{(int)(PlayerRace.Kobold.ID)},{(int)(PlayerRace.Troll.ID)},{(int)(PlayerRace.Valkyn.ID)},{(int)(PlayerRace.Frostalf.ID)}",
                    BaseHP = 560,
                    BaseWeaponSkill = 280,
                    ClassType = (byte)eClassType.ListCaster,
                    MaxTensionFactor = 1.07f,
            ...
            },
            {
                ...
                new DBCharacterClass()
                {
                    ...
                    SecondaryStat = (int)eStat.DEX,
                    TertiaryStat = (int)eStat.CON,
                    EligibleRaces = $"{(int)(PlayerRace.Dwarf.ID)},{(int)(PlayerRace.Deifrang.ID)},{(int)(PlayerRace.Norseman.ID)},{(int)(PlayerRace.Troll.ID)},{(int)(PlayerRace.Valkyn.ID)},{(int)(PlayerRace.Kobold.ID)}",
                    CanUseLeftHandedWeapon = true,
                    BaseHP = 880,
                    BaseWeaponSkill = 440,
                    ClassType = (byte)eClassType.PureTank,
            ...
            },
            {
                ...
                new DBCharacterClass()
                {
                    ...
                    SecondaryStat = (int)eStat.DEX,
                    TertiaryStat = (int)eStat.CON,
                    EligibleRaces = $"{(int)(PlayerRace.Celt.ID)},{(int)(PlayerRace.Elf.ID)},{(int)(PlayerRace.Firbolg.ID)},{(int)(PlayerRace.Graoch.ID)},{(int)(PlayerRace.Shar.ID)},{(int)(PlayerRace.Lurikeen.ID)}",
                    CanUseLeftHandedWeapon = true,
                    BaseHP = 880,
                    BaseWeaponSkill = 440,
                    ClassType = (byte)eClassType.PureTank,
            ...
            },
            {
                ...
                new DBCharacterClass()
                {
                    ...
                    TertiaryStat = (int)eStat.DEX,
                    ManaStat = (int)eStat.INT,
                    EligibleRaces = $"{(int)(PlayerRace.Celt.ID)},{(int)(PlayerRace.Elf.ID)},{(int)(PlayerRace.Graoch.ID)},{(int)(PlayerRace.Lurikeen.ID)},{(int)(PlayerRace.Shar.ID)},{(int)(PlayerRace.Sylvan.ID)}",
                    BaseHP = 760,
                    BaseWeaponSkill = 380,
                    ClassType = (byte)eClassType.Hybrid,
                    MaxTensionFactor = 1.15f, 
            ...
            },
            {
                ...
                new DBCharacterClass()
                {
                    ...
                    TertiaryStat = (int)eStat.CON,
                    ManaStat = (int)eStat.EMP,
                    EligibleRaces = $"{(int)(PlayerRace.Celt.ID)},{(int)(PlayerRace.Firbolg.ID)},{(int)(PlayerRace.Graoch.ID)},{(int)(PlayerRace.Sylvan.ID)},{(int)(PlayerRace.Shar.ID)}",
                    BaseHP = 720,
                    BaseWeaponSkill = 360,
                    ClassType = (byte)eClassType.Hybrid,
                    MaxPulsingSpells = 2,
                    MaxTensionFactor = 1.11f, 
                    AdrenalineSpellID = AdrenalineSpellHandler.TANK_ADRENALINE_SPELL_ID
                }
            },
            {
            ...
            },
            {
                ...
                new DBCharacterClass()
                {
                    ...
                    TertiaryStat = (int)eStat.DEX,
                    ManaStat = (int)eStat.INT,
                    EligibleRaces = $"{(int)(PlayerRace.Celt.ID)},{(int)(PlayerRace.Firbolg.ID)},{(int)(PlayerRace.Sylvan.ID)},{(int)(PlayerRace.Elf.ID)}",
                    BaseHP = 560,
                    BaseWeaponSkill = 280,
                    ClassType = (byte)eClassType.ListCaster,
                    MaxTensionFactor = 1.04f, 
            ...
            },
            {
                ...
                new DBCharacterClass()
                {
                    ...
                    EligibleRaces = $"{(int)(PlayerRace.Korazh.ID)},{(int)(PlayerRace.Briton.ID)},{(int)(PlayerRace.Inconnu.ID)},{(int)(PlayerRace.HalfOgre.ID)}",
                    CanUseLeftHandedWeapon = true,
                    BaseHP = 600,
                    BaseWeaponSkill = 440,
                    ClassType = (byte)eClassType.Hybrid,
            ...
            },
            {
                ...
                new DBCharacterClass()
                {
                    ...
                    TertiaryStat = (int)eStat.QUI,
                    ManaStat = (int)eStat.STR,
                    EligibleRaces = $"{(int)(PlayerRace.Kobold.ID)},{(int)(PlayerRace.Deifrang.ID)},{(int)(PlayerRace.Norseman.ID)},{(int)(PlayerRace.Troll.ID)}",
                    CanUseLeftHandedWeapon = true,
                    BaseHP = 600,
                    BaseWeaponSkill = 440,
                    ClassType = (byte)eClassType.Hybrid,
            ...
            },
            {
                ...
                new DBCharacterClass()
                {
                    ...
                    TertiaryStat = (int)eStat.QUI,
                    ManaStat = (int)eStat.STR,
                    EligibleRaces = $"{(int)(PlayerRace.Celt.ID)},{(int)(PlayerRace.Graoch.ID)},{(int)(PlayerRace.Lurikeen.ID)},{(int)(PlayerRace.Firbolg.ID)}",
                    CanUseLeftHandedWeapon = true,
                    BaseHP = 600,
                    BaseWeaponSkill = 440,
                    ClassType = (byte)eClassType.Hybrid,
