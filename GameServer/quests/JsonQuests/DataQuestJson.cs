...
namespace DOL.GS.Quests
{
    ...
    public class DataQuestJson
    {
        ...
        /// </summary>
        private async Task<string> TranslateQuestText(GamePlayer player, string template, bool personalize)
        {
        ...
        public Task<string> GetDescriptionForPlayer(GamePlayer player)
            => TranslateQuestText(player, Description, personalize: false);

        public Task<string> GetSummaryForPlayer(GamePlayer player)
            => TranslateQuestText(player, Summary, personalize: true);

        public Task<string> GetStoryForPlayer(GamePlayer player)
            => TranslateQuestText(player, Story, personalize: true);

        public Task<string> GetConclusionForPlayer(GamePlayer player)
            => TranslateQuestText(player, Conclusion, personalize: true);

        public Task<string> GetAcceptTextForPlayer(GamePlayer player)
        {
            var raw = AcceptText.Replace(@"\n", "\n");
            return TranslateQuestText(player, raw, personalize: true);
        }
