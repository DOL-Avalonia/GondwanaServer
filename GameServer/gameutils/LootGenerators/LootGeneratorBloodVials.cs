...
namespace DOL.GS
{
    public class LootGeneratorBloodVials : LootGeneratorBase
    {
        ...
        public static ushort GetVialModel(string bloodType, int bodyType)
        {
            ...
            if (bloodType == "Demonic Ichor" || bloodType == "Putrefied Blood" || bloodType == "Void Sap")
                return 531; // Purple
        ...
        static LootGeneratorBloodVials()
        {
            var bloodDict = new Dictionary<string, ushort[]>
            {
                ...
                { "Liquid Hellfire", new ushort[] { 629, 635, 636 } },
                ...
                { "Pure Elemental Water", new ushort[] { 913, 928, 941, 944, 1269, 1275 } },
                ...
                { "Acidic Slime", new ushort[] { 123, 454, 457, 458, 654, 842, 1683, 1887, 2171, 2284, 2285 } },
                ...
                { "Machine Oil", new ushort[] { 241, 242, 243, 244, 831, 847, 953, 1181, 1393, 1690, 1691, 1692, 1693, 1694, 1695, 1696, 1697, 1823, 1863, 1866, 1867, 1868, 1878, 2026, 2058, 2117, 2238, 2239, 2240, 2241, 2242, 2251, 2252, 2255, 2256, 2266, 2269, 2270 } },
                { "Magical Blood", new ushort[] { 696, 698, 699, 764, 813, 857, 904, 905, 915, 973, 1171, 1172, 1173, 1174, 1175, 1176, 1177, 1178, 1179, 1180, 1212, 1219, 1236, 1264, 1350, 2158, 2250, 2258, 2265 } },
                { "Sticky Sap", new ushort[] { 97, 570, 844, 848, 946, 1702, 1703, 1704, 1910 } },
                { "Plant Nectar", new ushort[] { 571, 818, 862, 903, 1584 } },
                { "Spore Extract", new ushort[] { 820, 860, 906 } },
                ...
                { "None", new ushort[] { 22, 24, 25, 26, 916, 920, 927, 938, 952, 1938, 2046, 2213, 2217, 2220, 2221, 2262, 1438, 1583, 1672, 1681, 1684, 1685, 1686, 1822, 1905, 1906, 1957, 1958, 1959, 2009, 2010, 2011, 2012, 2074, 2279 } }
            };
