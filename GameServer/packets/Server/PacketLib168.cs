...
namespace DOL.GS.PacketHandler
{
    ...
    public class PacketLib168 : AbstractPacketLib, IPacketLib
    {
        ...
        public virtual void SendObjectUpdate(GameObject obj)
        {
            ...
            using (GSUDPPacketOut pak = PooledObjectFactory.GetForTick<GSUDPPacketOut>().Init(GetPacketCode(eServerPackets.ObjectUpdate)))
            {
        ...
        {
            await using var pak = PooledObjectFactory.GetForTick<GSTCPPacketOut>().Init(GetPacketCode(eServerPackets.Dialog));
            pak.WriteByte(0x00);
            pak.WriteByte(0x64);
        ...
        public virtual void SendCheckLOS(GameObject Checker, GameObject Target, CheckLOSResponse callback)
        {
            ...
            using (var pak = PooledObjectFactory.GetForTick<GSTCPPacketOut>().Init(GetPacketCode(eServerPackets.CheckLOSRequest)))
            {
        ...
        public virtual void SendCheckLOS(GameObject source, GameObject target, CheckLOSMgrResponse callback)
        {
            ...
            using (var pak = PooledObjectFactory.GetForTick<GSTCPPacketOut>().Init(0xD0))
            {
        ...
        {
            await using var pak = PooledObjectFactory.GetForTick<GSTCPPacketOut>().Init(GetPacketCode(eServerPackets.QuestEntry));
        ...
        public virtual async Task SendMessage(Task<string> msg, eChatType type, eChatLoc loc)
        {
            string message = await msg;
            SendMessage(message, type, loc);
        }
        
        public virtual async Task SendCustomDialog(Task<string> msg, CustomDialogResponse callback)
        {
            string message = await msg;
